...
AFRAME.registerComponent('rotary-interaction', {
    ...
    init() {
        ...
        for (let i = 0; i < 10; i++) {
            CONTEXT_AF.rotaryWheel.setAttribute('animation__rotateWheel' + i, {'property': 'rotation','from':{x:-50, y:0, z:0}, 'to': {x: -50, y: 0, z: -(CONTEXT_AF.data.angledif * (i + 1) + CONTEXT_AF.data.startangle)}, 'dur':1000, 'startEvents': 'startWheelAnim' + i, 'autoplay':false});
        }

        CONTEXT_AF.rotaryWheel.setAttribute('animation__returnWheel', {'property': 'rotation', 'to':{x:-50,y:0,z:0}, 'dur':1000, 'startEvents': 'animationcomplete__rotateWheel0,animationcomplete__rotateWheel1,animationcomplete__rotateWheel2,animationcomplete__rotateWheel3,animationcomplete__rotateWheel4,animationcomplete__rotateWheel5,animationcomplete__rotateWheel6,animationcomplete__rotateWheel7,animationcomplete__rotateWheel8,animationcomplete__rotateWheel9'});
        ...
        rotaryDisplay.setAttribute('scale',{x:2, y:2, z:2});
        ...
        for (let i = 0; i < 10; i++) {
            ...
            rotaryBtn.setAttribute('material', {color:'green', opacity:0.1});
            ...
            let btnText = document.createElement('a-entity');
            btnText.setAttribute('text', {'value':dialValue, align:'center', width:2});
            btnText.setAttribute('rotation', {x:-90,y:0,z:-(CONTEXT_AF.data.angledif * i + CONTEXT_AF.data.startangle)});
            rotaryBtn.appendChild(btnText);
        ...
        CONTEXT_AF.InputRotary = function (val) {
            ...
            CONTEXT_AF.rotaryWheel.setAttribute('animation__rotateWheel' + val, {'property': 'rotation','from':{x:-50, y:0, z:0}, 'to': {x: -50, y: 0, z: -(CONTEXT_AF.data.angledif * (val + 1) + CONTEXT_AF.data.startangle)}, 'dur':1000, 'startEvents': 'startWheelAnim' + val, 'autoplay':false});
            CONTEXT_AF.rotaryWheel.setAttribute('animation__returnWheel', {'property': 'rotation', 'to':{x:-50,y:0,z:0}, 'dur':1000, 'startEvents': 'animationcomplete__rotateWheel0,animationcomplete__rotateWheel1,animationcomplete__rotateWheel2,animationcomplete__rotateWheel3,animationcomplete__rotateWheel4,animationcomplete__rotateWheel5,animationcomplete__rotateWheel6,animationcomplete__rotateWheel7,animationcomplete__rotateWheel8,animationcomplete__rotateWheel9'});
